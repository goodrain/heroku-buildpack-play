...
download_play_official() {
  ...
  local playUrl="http://lang.goodrain.me/play/${playZipFile}"
...
Please check that the version ${playVersion} is correct in your conf/dependencies.yml"
    ...
    echo "Downloading ${playZipFile} from http://lang.goodrain.me" | indent
...
{
  VER_TO_INSTALL=$1
  PLAY_URL="http://lang.goodrain.me/play/play-heroku-$VER_TO_INSTALL.tar.gz"
